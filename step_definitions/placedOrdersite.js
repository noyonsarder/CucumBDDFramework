...
When('I click add to cart for the product {string}', { timeout: 100 * 1000 }, async function (productName) {
...
Then ('I verified the order number',{ timeout: 100 * 1000 }, async function(){
